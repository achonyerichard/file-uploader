        ...
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-1/2 justify-center items-start text-center md:text-left">
            ...
            <h1 className="my-4 text-5xl font-bold leading-tight">
              Welcome to Trex Video Upload Services
            </h1>
            <p className="leading-normal text-2xl mb-8 font-semibold">
              Upload and store
            </p>
          ...
          <div className="w-full md:w-2/5 py-6  text-white">
            <img
              className="w-full md:w-4/5 z-50 text-white"
              alt=""
              src={logo}
            />
          </div>
